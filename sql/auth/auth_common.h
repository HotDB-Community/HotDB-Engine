...
enum hotdbengine_db_table_field {
  HOTDBENGINE_DB_FIELD_HOST = 0,
  HOTDBENGINE_DB_FIELD_DB,
  HOTDBENGINE_DB_FIELD_USER,
  HOTDBENGINE_DB_FIELD_SELECT_PRIV,
  HOTDBENGINE_DB_FIELD_INSERT_PRIV,
  HOTDBENGINE_DB_FIELD_UPDATE_PRIV,
  HOTDBENGINE_DB_FIELD_DELETE_PRIV,
  HOTDBENGINE_DB_FIELD_CREATE_PRIV,
  HOTDBENGINE_DB_FIELD_DROP_PRIV,
  HOTDBENGINE_DB_FIELD_GRANT_PRIV,
  HOTDBENGINE_DB_FIELD_REFERENCES_PRIV,
  HOTDBENGINE_DB_FIELD_INDEX_PRIV,
  HOTDBENGINE_DB_FIELD_ALTER_PRIV,
  HOTDBENGINE_DB_FIELD_CREATE_TMP_TABLE_PRIV,
  HOTDBENGINE_DB_FIELD_LOCK_TABLES_PRIV,
  HOTDBENGINE_DB_FIELD_CREATE_VIEW_PRIV,
  HOTDBENGINE_DB_FIELD_SHOW_VIEW_PRIV,
  HOTDBENGINE_DB_FIELD_CREATE_ROUTINE_PRIV,
  HOTDBENGINE_DB_FIELD_ALTER_ROUTINE_PRIV,
  HOTDBENGINE_DB_FIELD_EXECUTE_PRIV,
  HOTDBENGINE_DB_FIELD_EVENT_PRIV,
  HOTDBENGINE_DB_FIELD_TRIGGER_PRIV,
  HOTDBENGINE_DB_FIELD_COUNT
};

enum hotdbengine_user_table_field {
  HOTDBENGINE_USER_FIELD_HOST = 0,
  HOTDBENGINE_USER_FIELD_USER,
  HOTDBENGINE_USER_FIELD_SELECT_PRIV,
  HOTDBENGINE_USER_FIELD_INSERT_PRIV,
  HOTDBENGINE_USER_FIELD_UPDATE_PRIV,
  HOTDBENGINE_USER_FIELD_DELETE_PRIV,
  HOTDBENGINE_USER_FIELD_CREATE_PRIV,
  HOTDBENGINE_USER_FIELD_DROP_PRIV,
  HOTDBENGINE_USER_FIELD_RELOAD_PRIV,
  HOTDBENGINE_USER_FIELD_SHUTDOWN_PRIV,
  HOTDBENGINE_USER_FIELD_PROCESS_PRIV,
  HOTDBENGINE_USER_FIELD_FILE_PRIV,
  HOTDBENGINE_USER_FIELD_GRANT_PRIV,
  HOTDBENGINE_USER_FIELD_REFERENCES_PRIV,
  HOTDBENGINE_USER_FIELD_INDEX_PRIV,
  HOTDBENGINE_USER_FIELD_ALTER_PRIV,
  HOTDBENGINE_USER_FIELD_SHOW_DB_PRIV,
  HOTDBENGINE_USER_FIELD_SUPER_PRIV,
  HOTDBENGINE_USER_FIELD_CREATE_TMP_TABLE_PRIV,
  HOTDBENGINE_USER_FIELD_LOCK_TABLES_PRIV,
  HOTDBENGINE_USER_FIELD_EXECUTE_PRIV,
  HOTDBENGINE_USER_FIELD_REPL_SLAVE_PRIV,
  HOTDBENGINE_USER_FIELD_REPL_CLIENT_PRIV,
  HOTDBENGINE_USER_FIELD_CREATE_VIEW_PRIV,
  HOTDBENGINE_USER_FIELD_SHOW_VIEW_PRIV,
  HOTDBENGINE_USER_FIELD_CREATE_ROUTINE_PRIV,
  HOTDBENGINE_USER_FIELD_ALTER_ROUTINE_PRIV,
  HOTDBENGINE_USER_FIELD_CREATE_USER_PRIV,
  HOTDBENGINE_USER_FIELD_EVENT_PRIV,
  HOTDBENGINE_USER_FIELD_TRIGGER_PRIV,
  HOTDBENGINE_USER_FIELD_CREATE_TABLESPACE_PRIV,
  HOTDBENGINE_USER_FIELD_SSL_TYPE,
  HOTDBENGINE_USER_FIELD_SSL_CIPHER,
  HOTDBENGINE_USER_FIELD_X509_ISSUER,
  HOTDBENGINE_USER_FIELD_X509_SUBJECT,
  HOTDBENGINE_USER_FIELD_MAX_QUESTIONS,
  HOTDBENGINE_USER_FIELD_MAX_UPDATES,
  HOTDBENGINE_USER_FIELD_MAX_CONNECTIONS,
  HOTDBENGINE_USER_FIELD_MAX_USER_CONNECTIONS,
  HOTDBENGINE_USER_FIELD_PLUGIN,
  HOTDBENGINE_USER_FIELD_AUTHENTICATION_STRING,
  HOTDBENGINE_USER_FIELD_PASSWORD_EXPIRED,
  HOTDBENGINE_USER_FIELD_PASSWORD_LAST_CHANGED,
  HOTDBENGINE_USER_FIELD_PASSWORD_LIFETIME,
  HOTDBENGINE_USER_FIELD_ACCOUNT_LOCKED,
  HOTDBENGINE_USER_FIELD_CREATE_ROLE_PRIV,
  HOTDBENGINE_USER_FIELD_DROP_ROLE_PRIV,
  HOTDBENGINE_USER_FIELD_PASSWORD_REUSE_HISTORY,
  HOTDBENGINE_USER_FIELD_PASSWORD_REUSE_TIME,
  HOTDBENGINE_USER_FIELD_PASSWORD_REQUIRE_CURRENT,
  HOTDBENGINE_USER_FIELD_USER_ATTRIBUTES,
  HOTDBENGINE_USER_FIELD_COUNT
};

enum hotdbengine_proxies_priv_table_feild {
  HOTDBENGINE_PROXIES_PRIV_FIELD_HOST = 0,
  HOTDBENGINE_PROXIES_PRIV_FIELD_USER,
  HOTDBENGINE_PROXIES_PRIV_FIELD_PROXIED_HOST,
  HOTDBENGINE_PROXIES_PRIV_FIELD_PROXIED_USER,
  HOTDBENGINE_PROXIES_PRIV_FIELD_WITH_GRANT,
  HOTDBENGINE_PROXIES_PRIV_FIELD_GRANTOR,
  HOTDBENGINE_PROXIES_PRIV_FIELD_TIMESTAMP,
  HOTDBENGINE_PROXIES_PRIV_FIELD_COUNT
};

enum hotdbengine_procs_priv_table_field {
  HOTDBENGINE_PROCS_PRIV_FIELD_HOST = 0,
  HOTDBENGINE_PROCS_PRIV_FIELD_DB,
  HOTDBENGINE_PROCS_PRIV_FIELD_USER,
  HOTDBENGINE_PROCS_PRIV_FIELD_ROUTINE_NAME,
  HOTDBENGINE_PROCS_PRIV_FIELD_ROUTINE_TYPE,
  HOTDBENGINE_PROCS_PRIV_FIELD_GRANTOR,
  HOTDBENGINE_PROCS_PRIV_FIELD_PROC_PRIV,
  HOTDBENGINE_PROCS_PRIV_FIELD_TIMESTAMP,
  HOTDBENGINE_PROCS_PRIV_FIELD_COUNT
};

enum hotdbengine_columns_priv_table_field {
  HOTDBENGINE_COLUMNS_PRIV_FIELD_HOST = 0,
  HOTDBENGINE_COLUMNS_PRIV_FIELD_DB,
  HOTDBENGINE_COLUMNS_PRIV_FIELD_USER,
  HOTDBENGINE_COLUMNS_PRIV_FIELD_TABLE_NAME,
  HOTDBENGINE_COLUMNS_PRIV_FIELD_COLUMN_NAME,
  HOTDBENGINE_COLUMNS_PRIV_FIELD_TIMESTAMP,
  HOTDBENGINE_COLUMNS_PRIV_FIELD_COLUMN_PRIV,
  HOTDBENGINE_COLUMNS_PRIV_FIELD_COUNT
};

enum hotdbengine_tables_priv_table_field {
  HOTDBENGINE_TABLES_PRIV_FIELD_HOST = 0,
  HOTDBENGINE_TABLES_PRIV_FIELD_DB,
  HOTDBENGINE_TABLES_PRIV_FIELD_USER,
  HOTDBENGINE_TABLES_PRIV_FIELD_TABLE_NAME,
  HOTDBENGINE_TABLES_PRIV_FIELD_GRANTOR,
  HOTDBENGINE_TABLES_PRIV_FIELD_TIMESTAMP,
  HOTDBENGINE_TABLES_PRIV_FIELD_TABLE_PRIV,
  HOTDBENGINE_TABLES_PRIV_FIELD_COLUMN_PRIV,
  HOTDBENGINE_TABLES_PRIV_FIELD_COUNT
};

enum hotdbengine_role_edges_table_field {
  HOTDBENGINE_ROLE_EDGES_FIELD_FROM_HOST = 0,
  HOTDBENGINE_ROLE_EDGES_FIELD_FROM_USER,
  HOTDBENGINE_ROLE_EDGES_FIELD_TO_HOST,
  HOTDBENGINE_ROLE_EDGES_FIELD_TO_USER,
  HOTDBENGINE_ROLE_EDGES_FIELD_WITH_ADMIN_OPTION,
  HOTDBENGINE_ROLE_EDGES_FIELD_COUNT
};

enum hotdbengine_default_roles_table_field {
  HOTDBENGINE_DEFAULT_ROLES_FIELD_HOST = 0,
  HOTDBENGINE_DEFAULT_ROLES_FIELD_USER,
  HOTDBENGINE_DEFAULT_ROLES_FIELD_DEFAULT_ROLE_HOST,
  HOTDBENGINE_DEFAULT_ROLES_FIELD_DEFAULT_ROLE_USER,
  HOTDBENGINE_DEFAULT_ROLES_FIELD_COUNT
};

enum hotdbengine_password_history_table_field {
  HOTDBENGINE_PASSWORD_HISTORY_FIELD_HOST = 0,
  HOTDBENGINE_PASSWORD_HISTORY_FIELD_USER,
  HOTDBENGINE_PASSWORD_HISTORY_FIELD_PASSWORD_TIMESTAMP,
  HOTDBENGINE_PASSWORD_HISTORY_FIELD_PASSWORD,
  HOTDBENGINE_PASSWORD_HISTORY_FIELD_COUNT
};

enum hotdbengine_dynamic_priv_table_field {
  HOTDBENGINE_DYNAMIC_PRIV_FIELD_USER = 0,
  HOTDBENGINE_DYNAMIC_PRIV_FIELD_HOST,
  HOTDBENGINE_DYNAMIC_PRIV_FIELD_PRIV,
  HOTDBENGINE_DYNAMIC_PRIV_FIELD_WITH_GRANT_OPTION,
  HOTDBENGINE_DYNAMIC_PRIV_FIELD_COUNT
};
...
class User_table_current_schema : public User_table_schema {
 public:
  uint host_idx() override { return HOTDBENGINE_USER_FIELD_HOST; }
  uint user_idx() override { return HOTDBENGINE_USER_FIELD_USER; }
  // not available
  uint password_idx() override {
    assert(0);
    return HOTDBENGINE_USER_FIELD_COUNT;
  }
  uint select_priv_idx() override { return HOTDBENGINE_USER_FIELD_SELECT_PRIV; }
  uint insert_priv_idx() override { return HOTDBENGINE_USER_FIELD_INSERT_PRIV; }
  uint update_priv_idx() override { return HOTDBENGINE_USER_FIELD_UPDATE_PRIV; }
  uint delete_priv_idx() override { return HOTDBENGINE_USER_FIELD_DELETE_PRIV; }
  uint create_priv_idx() override { return HOTDBENGINE_USER_FIELD_CREATE_PRIV; }
  uint drop_priv_idx() override { return HOTDBENGINE_USER_FIELD_DROP_PRIV; }
  uint reload_priv_idx() override { return HOTDBENGINE_USER_FIELD_RELOAD_PRIV; }
  uint shutdown_priv_idx() override { return HOTDBENGINE_USER_FIELD_SHUTDOWN_PRIV; }
  uint process_priv_idx() override { return HOTDBENGINE_USER_FIELD_PROCESS_PRIV; }
  uint file_priv_idx() override { return HOTDBENGINE_USER_FIELD_FILE_PRIV; }
  uint grant_priv_idx() override { return HOTDBENGINE_USER_FIELD_GRANT_PRIV; }
  uint references_priv_idx() override {
    return HOTDBENGINE_USER_FIELD_REFERENCES_PRIV;
  }
  uint index_priv_idx() override { return HOTDBENGINE_USER_FIELD_INDEX_PRIV; }
  uint alter_priv_idx() override { return HOTDBENGINE_USER_FIELD_ALTER_PRIV; }
  uint show_db_priv_idx() override { return HOTDBENGINE_USER_FIELD_SHOW_DB_PRIV; }
  uint super_priv_idx() override { return HOTDBENGINE_USER_FIELD_SUPER_PRIV; }
  uint create_role_priv_idx() override {
    return HOTDBENGINE_USER_FIELD_CREATE_ROLE_PRIV;
  }
  uint drop_role_priv_idx() override { return HOTDBENGINE_USER_FIELD_DROP_ROLE_PRIV; }
  uint create_tmp_table_priv_idx() override {
    return HOTDBENGINE_USER_FIELD_CREATE_TMP_TABLE_PRIV;
  }
  uint lock_tables_priv_idx() override {
    return HOTDBENGINE_USER_FIELD_LOCK_TABLES_PRIV;
  }
  uint execute_priv_idx() override { return HOTDBENGINE_USER_FIELD_EXECUTE_PRIV; }
  uint repl_slave_priv_idx() override {
    return HOTDBENGINE_USER_FIELD_REPL_SLAVE_PRIV;
  }
  uint repl_client_priv_idx() override {
    return HOTDBENGINE_USER_FIELD_REPL_CLIENT_PRIV;
  }
  uint create_view_priv_idx() override {
    return HOTDBENGINE_USER_FIELD_CREATE_VIEW_PRIV;
  }
  uint show_view_priv_idx() override { return HOTDBENGINE_USER_FIELD_SHOW_VIEW_PRIV; }
  uint create_routine_priv_idx() override {
    return HOTDBENGINE_USER_FIELD_CREATE_ROUTINE_PRIV;
  }
  uint alter_routine_priv_idx() override {
    return HOTDBENGINE_USER_FIELD_ALTER_ROUTINE_PRIV;
  }
  uint create_user_priv_idx() override {
    return HOTDBENGINE_USER_FIELD_CREATE_USER_PRIV;
  }
  uint event_priv_idx() override { return HOTDBENGINE_USER_FIELD_EVENT_PRIV; }
  uint trigger_priv_idx() override { return HOTDBENGINE_USER_FIELD_TRIGGER_PRIV; }
  uint create_tablespace_priv_idx() override {
    return HOTDBENGINE_USER_FIELD_CREATE_TABLESPACE_PRIV;
  }
  uint ssl_type_idx() override { return HOTDBENGINE_USER_FIELD_SSL_TYPE; }
  uint ssl_cipher_idx() override { return HOTDBENGINE_USER_FIELD_SSL_CIPHER; }
  uint x509_issuer_idx() override { return HOTDBENGINE_USER_FIELD_X509_ISSUER; }
  uint x509_subject_idx() override { return HOTDBENGINE_USER_FIELD_X509_SUBJECT; }
  uint max_questions_idx() override { return HOTDBENGINE_USER_FIELD_MAX_QUESTIONS; }
  uint max_updates_idx() override { return HOTDBENGINE_USER_FIELD_MAX_UPDATES; }
  uint max_connections_idx() override {
    return HOTDBENGINE_USER_FIELD_MAX_CONNECTIONS;
  }
  uint max_user_connections_idx() override {
    return HOTDBENGINE_USER_FIELD_MAX_USER_CONNECTIONS;
  }
  uint plugin_idx() override { return HOTDBENGINE_USER_FIELD_PLUGIN; }
  uint authentication_string_idx() override {
    return HOTDBENGINE_USER_FIELD_AUTHENTICATION_STRING;
  }
  uint password_expired_idx() override {
    return HOTDBENGINE_USER_FIELD_PASSWORD_EXPIRED;
  }
  uint password_last_changed_idx() override {
    return HOTDBENGINE_USER_FIELD_PASSWORD_LAST_CHANGED;
  }
  uint password_lifetime_idx() override {
    return HOTDBENGINE_USER_FIELD_PASSWORD_LIFETIME;
  }
  uint account_locked_idx() override { return HOTDBENGINE_USER_FIELD_ACCOUNT_LOCKED; }
  uint password_reuse_history_idx() override {
    return HOTDBENGINE_USER_FIELD_PASSWORD_REUSE_HISTORY;
  }
  uint password_reuse_time_idx() override {
    return HOTDBENGINE_USER_FIELD_PASSWORD_REUSE_TIME;
  }
  uint password_require_current_idx() override {
    return HOTDBENGINE_USER_FIELD_PASSWORD_REQUIRE_CURRENT;
  }
  uint user_attributes_idx() override {
    return HOTDBENGINE_USER_FIELD_USER_ATTRIBUTES;
  }
};
...
class User_table_old_schema : public User_table_schema {
 public:
  enum hotdbengine_user_table_field_56 {
    HOTDBENGINE_USER_FIELD_HOST_56 = 0,
    HOTDBENGINE_USER_FIELD_USER_56,
    HOTDBENGINE_USER_FIELD_PASSWORD_56,
    HOTDBENGINE_USER_FIELD_SELECT_PRIV_56,
    HOTDBENGINE_USER_FIELD_INSERT_PRIV_56,
    HOTDBENGINE_USER_FIELD_UPDATE_PRIV_56,
    HOTDBENGINE_USER_FIELD_DELETE_PRIV_56,
    HOTDBENGINE_USER_FIELD_CREATE_PRIV_56,
    HOTDBENGINE_USER_FIELD_DROP_PRIV_56,
    HOTDBENGINE_USER_FIELD_RELOAD_PRIV_56,
    HOTDBENGINE_USER_FIELD_SHUTDOWN_PRIV_56,
    HOTDBENGINE_USER_FIELD_PROCESS_PRIV_56,
    HOTDBENGINE_USER_FIELD_FILE_PRIV_56,
    HOTDBENGINE_USER_FIELD_GRANT_PRIV_56,
    HOTDBENGINE_USER_FIELD_REFERENCES_PRIV_56,
    HOTDBENGINE_USER_FIELD_INDEX_PRIV_56,
    HOTDBENGINE_USER_FIELD_ALTER_PRIV_56,
    HOTDBENGINE_USER_FIELD_SHOW_DB_PRIV_56,
    HOTDBENGINE_USER_FIELD_SUPER_PRIV_56,
    HOTDBENGINE_USER_FIELD_CREATE_TMP_TABLE_PRIV_56,
    HOTDBENGINE_USER_FIELD_LOCK_TABLES_PRIV_56,
    HOTDBENGINE_USER_FIELD_EXECUTE_PRIV_56,
    HOTDBENGINE_USER_FIELD_REPL_SLAVE_PRIV_56,
    HOTDBENGINE_USER_FIELD_REPL_CLIENT_PRIV_56,
    HOTDBENGINE_USER_FIELD_CREATE_VIEW_PRIV_56,
    HOTDBENGINE_USER_FIELD_SHOW_VIEW_PRIV_56,
    HOTDBENGINE_USER_FIELD_CREATE_ROUTINE_PRIV_56,
    HOTDBENGINE_USER_FIELD_ALTER_ROUTINE_PRIV_56,
    HOTDBENGINE_USER_FIELD_CREATE_USER_PRIV_56,
    HOTDBENGINE_USER_FIELD_EVENT_PRIV_56,
    HOTDBENGINE_USER_FIELD_TRIGGER_PRIV_56,
    HOTDBENGINE_USER_FIELD_CREATE_TABLESPACE_PRIV_56,
    HOTDBENGINE_USER_FIELD_SSL_TYPE_56,
    HOTDBENGINE_USER_FIELD_SSL_CIPHER_56,
    HOTDBENGINE_USER_FIELD_X509_ISSUER_56,
    HOTDBENGINE_USER_FIELD_X509_SUBJECT_56,
    HOTDBENGINE_USER_FIELD_MAX_QUESTIONS_56,
    HOTDBENGINE_USER_FIELD_MAX_UPDATES_56,
    HOTDBENGINE_USER_FIELD_MAX_CONNECTIONS_56,
    HOTDBENGINE_USER_FIELD_MAX_USER_CONNECTIONS_56,
    HOTDBENGINE_USER_FIELD_PLUGIN_56,
    HOTDBENGINE_USER_FIELD_AUTHENTICATION_STRING_56,
    HOTDBENGINE_USER_FIELD_PASSWORD_EXPIRED_56,
    HOTDBENGINE_USER_FIELD_COUNT_56
  };

  uint host_idx() override { return HOTDBENGINE_USER_FIELD_HOST_56; }
  uint user_idx() override { return HOTDBENGINE_USER_FIELD_USER_56; }
  uint password_idx() override { return HOTDBENGINE_USER_FIELD_PASSWORD_56; }
  uint select_priv_idx() override { return HOTDBENGINE_USER_FIELD_SELECT_PRIV_56; }
  uint insert_priv_idx() override { return HOTDBENGINE_USER_FIELD_INSERT_PRIV_56; }
  uint update_priv_idx() override { return HOTDBENGINE_USER_FIELD_UPDATE_PRIV_56; }
  uint delete_priv_idx() override { return HOTDBENGINE_USER_FIELD_DELETE_PRIV_56; }
  uint create_priv_idx() override { return HOTDBENGINE_USER_FIELD_CREATE_PRIV_56; }
  uint drop_priv_idx() override { return HOTDBENGINE_USER_FIELD_DROP_PRIV_56; }
  uint reload_priv_idx() override { return HOTDBENGINE_USER_FIELD_RELOAD_PRIV_56; }
  uint shutdown_priv_idx() override {
    return HOTDBENGINE_USER_FIELD_SHUTDOWN_PRIV_56;
  }
  uint process_priv_idx() override { return HOTDBENGINE_USER_FIELD_PROCESS_PRIV_56; }
  uint file_priv_idx() override { return HOTDBENGINE_USER_FIELD_FILE_PRIV_56; }
  uint grant_priv_idx() override { return HOTDBENGINE_USER_FIELD_GRANT_PRIV_56; }
  uint references_priv_idx() override {
    return HOTDBENGINE_USER_FIELD_REFERENCES_PRIV_56;
  }
  uint index_priv_idx() override { return HOTDBENGINE_USER_FIELD_INDEX_PRIV_56; }
  uint alter_priv_idx() override { return HOTDBENGINE_USER_FIELD_ALTER_PRIV_56; }
  uint show_db_priv_idx() override { return HOTDBENGINE_USER_FIELD_SHOW_DB_PRIV_56; }
  uint super_priv_idx() override { return HOTDBENGINE_USER_FIELD_SUPER_PRIV_56; }
  uint create_tmp_table_priv_idx() override {
    return HOTDBENGINE_USER_FIELD_CREATE_TMP_TABLE_PRIV_56;
  }
  uint lock_tables_priv_idx() override {
    return HOTDBENGINE_USER_FIELD_LOCK_TABLES_PRIV_56;
  }
  uint execute_priv_idx() override { return HOTDBENGINE_USER_FIELD_EXECUTE_PRIV_56; }
  uint repl_slave_priv_idx() override {
    return HOTDBENGINE_USER_FIELD_REPL_SLAVE_PRIV_56;
  }
  uint repl_client_priv_idx() override {
    return HOTDBENGINE_USER_FIELD_REPL_CLIENT_PRIV_56;
  }
  uint create_view_priv_idx() override {
    return HOTDBENGINE_USER_FIELD_CREATE_VIEW_PRIV_56;
  }
  uint show_view_priv_idx() override {
    return HOTDBENGINE_USER_FIELD_SHOW_VIEW_PRIV_56;
  }
  uint create_routine_priv_idx() override {
    return HOTDBENGINE_USER_FIELD_CREATE_ROUTINE_PRIV_56;
  }
  uint alter_routine_priv_idx() override {
    return HOTDBENGINE_USER_FIELD_ALTER_ROUTINE_PRIV_56;
  }
  uint create_user_priv_idx() override {
    return HOTDBENGINE_USER_FIELD_CREATE_USER_PRIV_56;
  }
  uint event_priv_idx() override { return HOTDBENGINE_USER_FIELD_EVENT_PRIV_56; }
  uint trigger_priv_idx() override { return HOTDBENGINE_USER_FIELD_TRIGGER_PRIV_56; }
  uint create_tablespace_priv_idx() override {
    return HOTDBENGINE_USER_FIELD_CREATE_TABLESPACE_PRIV_56;
  }
  uint ssl_type_idx() override { return HOTDBENGINE_USER_FIELD_SSL_TYPE_56; }
  uint ssl_cipher_idx() override { return HOTDBENGINE_USER_FIELD_SSL_CIPHER_56; }
  uint x509_issuer_idx() override { return HOTDBENGINE_USER_FIELD_X509_ISSUER_56; }
  uint x509_subject_idx() override { return HOTDBENGINE_USER_FIELD_X509_SUBJECT_56; }
  uint max_questions_idx() override {
    return HOTDBENGINE_USER_FIELD_MAX_QUESTIONS_56;
  }
  uint max_updates_idx() override { return HOTDBENGINE_USER_FIELD_MAX_UPDATES_56; }
  uint max_connections_idx() override {
    return HOTDBENGINE_USER_FIELD_MAX_CONNECTIONS_56;
  }
  uint max_user_connections_idx() override {
    return HOTDBENGINE_USER_FIELD_MAX_USER_CONNECTIONS_56;
  }
  uint plugin_idx() override { return HOTDBENGINE_USER_FIELD_PLUGIN_56; }
  uint authentication_string_idx() override {
    return HOTDBENGINE_USER_FIELD_AUTHENTICATION_STRING_56;
  }
  uint password_expired_idx() override {
    return HOTDBENGINE_USER_FIELD_PASSWORD_EXPIRED_56;
  }

  // those fields are not available in 5.6 db schema
  uint password_last_changed_idx() override {
    return HOTDBENGINE_USER_FIELD_COUNT_56;
  }
  uint password_lifetime_idx() override { return HOTDBENGINE_USER_FIELD_COUNT_56; }
  uint account_locked_idx() override { return HOTDBENGINE_USER_FIELD_COUNT_56; }
  uint create_role_priv_idx() override { return HOTDBENGINE_USER_FIELD_COUNT_56; }
  uint drop_role_priv_idx() override { return HOTDBENGINE_USER_FIELD_COUNT_56; }
  uint password_reuse_history_idx() override {
    return HOTDBENGINE_USER_FIELD_COUNT_56;
  }
  uint password_reuse_time_idx() override { return HOTDBENGINE_USER_FIELD_COUNT_56; }
  uint password_require_current_idx() override {
    return HOTDBENGINE_USER_FIELD_COUNT_56;
  }
  uint user_attributes_idx() override { return HOTDBENGINE_USER_FIELD_COUNT_56; }
};
