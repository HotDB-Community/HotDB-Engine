...
class ACL_PROXY_USER : public ACL_ACCESS {
  ...
  typedef enum {
    HOTDBENGINE_PROXIES_PRIV_HOST,
    HOTDBENGINE_PROXIES_PRIV_USER,
    HOTDBENGINE_PROXIES_PRIV_PROXIED_HOST,
    HOTDBENGINE_PROXIES_PRIV_PROXIED_USER,
    HOTDBENGINE_PROXIES_PRIV_WITH_GRANT,
    HOTDBENGINE_PROXIES_PRIV_GRANTOR,
    HOTDBENGINE_PROXIES_PRIV_TIMESTAMP
  } old_acl_proxy_users;
