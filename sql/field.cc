...
#define FLAGSTR(V, F) ((V) & (F) ? #F " " : "")
  ...
  /** FOR HOTDB*/
const enum_field_types HOTDBENGINE_TYPE_DECIMAL     = MYSQL_TYPE_DECIMAL;
const enum_field_types HOTDBENGINE_TYPE_TINY        = MYSQL_TYPE_TINY;
const enum_field_types HOTDBENGINE_TYPE_SHORT       = MYSQL_TYPE_SHORT;
const enum_field_types HOTDBENGINE_TYPE_LONG        = MYSQL_TYPE_LONG;
const enum_field_types HOTDBENGINE_TYPE_FLOAT       = MYSQL_TYPE_FLOAT;
const enum_field_types HOTDBENGINE_TYPE_DOUBLE      = MYSQL_TYPE_DOUBLE;
const enum_field_types HOTDBENGINE_TYPE_NULL        = MYSQL_TYPE_NULL;
const enum_field_types HOTDBENGINE_TYPE_TIMESTAMP   = MYSQL_TYPE_TIMESTAMP;
const enum_field_types HOTDBENGINE_TYPE_LONGLONG    = MYSQL_TYPE_LONGLONG;
const enum_field_types HOTDBENGINE_TYPE_INT24       = MYSQL_TYPE_INT24;
const enum_field_types HOTDBENGINE_TYPE_DATE        = MYSQL_TYPE_DATE;
const enum_field_types HOTDBENGINE_TYPE_TIME        = MYSQL_TYPE_TIME;
const enum_field_types HOTDBENGINE_TYPE_DATETIME    = MYSQL_TYPE_DATETIME;
const enum_field_types HOTDBENGINE_TYPE_YEAR        = MYSQL_TYPE_YEAR;
const enum_field_types HOTDBENGINE_TYPE_NEWDATE     = MYSQL_TYPE_NEWDATE;
const enum_field_types HOTDBENGINE_TYPE_VARCHAR     = MYSQL_TYPE_VARCHAR;
const enum_field_types HOTDBENGINE_TYPE_BIT         = MYSQL_TYPE_BIT;
const enum_field_types HOTDBENGINE_TYPE_TIMESTAMP2  = MYSQL_TYPE_TIMESTAMP2;
const enum_field_types HOTDBENGINE_TYPE_DATETIME2   = MYSQL_TYPE_DATETIME2;
const enum_field_types HOTDBENGINE_TYPE_TIME2       = MYSQL_TYPE_TIME2;
const enum_field_types HOTDBENGINE_TYPE_TYPED_ARRAY = MYSQL_TYPE_TYPED_ARRAY;
const enum_field_types HOTDBENGINE_TYPE_INVALID     = MYSQL_TYPE_INVALID;
const enum_field_types HOTDBENGINE_TYPE_BOOL        = MYSQL_TYPE_BOOL;
const enum_field_types HOTDBENGINE_TYPE_JSON        = MYSQL_TYPE_JSON;
const enum_field_types HOTDBENGINE_TYPE_NEWDECIMAL  = MYSQL_TYPE_NEWDECIMAL;
const enum_field_types HOTDBENGINE_TYPE_ENUM        = MYSQL_TYPE_ENUM;
const enum_field_types HOTDBENGINE_TYPE_SET         = MYSQL_TYPE_SET;
const enum_field_types HOTDBENGINE_TYPE_TINY_BLOB   = MYSQL_TYPE_TINY_BLOB;
const enum_field_types HOTDBENGINE_TYPE_MEDIUM_BLOB = MYSQL_TYPE_MEDIUM_BLOB;
const enum_field_types HOTDBENGINE_TYPE_LONG_BLOB   = MYSQL_TYPE_LONG_BLOB;
const enum_field_types HOTDBENGINE_TYPE_BLOB        = MYSQL_TYPE_BLOB;
const enum_field_types HOTDBENGINE_TYPE_VAR_STRING  = MYSQL_TYPE_VAR_STRING;
const enum_field_types HOTDBENGINE_TYPE_STRING      = MYSQL_TYPE_STRING;
const enum_field_types HOTDBENGINE_TYPE_GEOMETRY    = MYSQL_TYPE_GEOMETRY;


const int HOTDBENGINE_TIME_WARN_TRUNCATED = 1;
const int HOTDBENGINE_TIME_WARN_OUT_OF_RANGE = 2;
const int HOTDBENGINE_TIME_WARN_INVALID_TIMESTAMP = 4;
const int HOTDBENGINE_TIME_WARN_ZERO_DATE = 8;
const int HOTDBENGINE_TIME_NOTE_TRUNCATED = 16;
const int HOTDBENGINE_TIME_WARN_ZERO_IN_DATE = 32;
const int HOTDBENGINE_TIME_WARN_DATETIME_OVERFLOW = 64;

const enum_mysql_timestamp_type  HOTDBENGINE_TIMESTAMP_NONE = enum_mysql_timestamp_type::MYSQL_TIMESTAMP_NONE;
const enum_mysql_timestamp_type  HOTDBENGINE_TIMESTAMP_ERROR = enum_mysql_timestamp_type::MYSQL_TIMESTAMP_ERROR;
const enum_mysql_timestamp_type  HOTDBENGINE_TIMESTAMP_DATE = enum_mysql_timestamp_type::MYSQL_TIMESTAMP_DATE;
const enum_mysql_timestamp_type  HOTDBENGINE_TIMESTAMP_DATETIME = enum_mysql_timestamp_type::MYSQL_TIMESTAMP_DATETIME;
const enum_mysql_timestamp_type  HOTDBENGINE_TIMESTAMP_TIME = enum_mysql_timestamp_type::MYSQL_TIMESTAMP_TIME;
const enum_mysql_timestamp_type  HOTDBENGINE_TIMESTAMP_DATETIME_TZ = enum_mysql_timestamp_type::MYSQL_TIMESTAMP_DATETIME_TZ;

typedef MYSQL_TIME HOTDBENGINE_TIME;
typedef MYSQL_TIME_STATUS HOTDBENGINE_TIME_STATUS;
...
*/
#define FIELDTYPE_TEAR_FROM (HOTDBENGINE_TYPE_BIT + 1)
...
static enum_field_types field_types_merge_rules[FIELDTYPE_NUM][FIELDTYPE_NUM] =
    {
        /* HOTDBENGINE_TYPE_DECIMAL -> */
        {// HOTDBENGINE_TYPE_DECIMAL      HOTDBENGINE_TYPE_TINY
         HOTDBENGINE_TYPE_NEWDECIMAL, HOTDBENGINE_TYPE_NEWDECIMAL,
         // HOTDBENGINE_TYPE_SHORT        HOTDBENGINE_TYPE_LONG
         HOTDBENGINE_TYPE_NEWDECIMAL, HOTDBENGINE_TYPE_NEWDECIMAL,
         // HOTDBENGINE_TYPE_FLOAT        HOTDBENGINE_TYPE_DOUBLE
         HOTDBENGINE_TYPE_DOUBLE, HOTDBENGINE_TYPE_DOUBLE,
         // HOTDBENGINE_TYPE_NULL         HOTDBENGINE_TYPE_TIMESTAMP
         HOTDBENGINE_TYPE_NEWDECIMAL, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_LONGLONG     HOTDBENGINE_TYPE_INT24
         HOTDBENGINE_TYPE_DECIMAL, HOTDBENGINE_TYPE_DECIMAL,
         // HOTDBENGINE_TYPE_DATE         HOTDBENGINE_TYPE_TIME
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_DATETIME     HOTDBENGINE_TYPE_YEAR
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_NEWDATE      HOTDBENGINE_TYPE_VARCHAR
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_BIT          HOTDBENGINE_TYPE_INVALID
         HOTDBENGINE_TYPE_NEWDECIMAL, HOTDBENGINE_TYPE_INVALID,
         // HOTDBENGINE_TYPE_BOOL         HOTDBENGINE_TYPE_JSON
         HOTDBENGINE_TYPE_DECIMAL, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_NEWDECIMAL   HOTDBENGINE_TYPE_ENUM
         HOTDBENGINE_TYPE_NEWDECIMAL, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_SET          HOTDBENGINE_TYPE_TINY_BLOB
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_TINY_BLOB,
         // HOTDBENGINE_TYPE_MEDIUM_BLOB  HOTDBENGINE_TYPE_LONG_BLOB
         HOTDBENGINE_TYPE_MEDIUM_BLOB, HOTDBENGINE_TYPE_LONG_BLOB,
         // HOTDBENGINE_TYPE_BLOB         HOTDBENGINE_TYPE_VAR_STRING
         HOTDBENGINE_TYPE_BLOB, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_STRING       HOTDBENGINE_TYPE_GEOMETRY
         HOTDBENGINE_TYPE_STRING, HOTDBENGINE_TYPE_VARCHAR},
        /* HOTDBENGINE_TYPE_TINY -> */
        {// HOTDBENGINE_TYPE_DECIMAL      HOTDBENGINE_TYPE_TINY
         HOTDBENGINE_TYPE_NEWDECIMAL, HOTDBENGINE_TYPE_TINY,
         // HOTDBENGINE_TYPE_SHORT        HOTDBENGINE_TYPE_LONG
         HOTDBENGINE_TYPE_SHORT, HOTDBENGINE_TYPE_LONG,
         // HOTDBENGINE_TYPE_FLOAT        HOTDBENGINE_TYPE_DOUBLE
         HOTDBENGINE_TYPE_FLOAT, HOTDBENGINE_TYPE_DOUBLE,
         // HOTDBENGINE_TYPE_NULL         HOTDBENGINE_TYPE_TIMESTAMP
         HOTDBENGINE_TYPE_TINY, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_LONGLONG     HOTDBENGINE_TYPE_INT24
         HOTDBENGINE_TYPE_LONGLONG, HOTDBENGINE_TYPE_INT24,
         // HOTDBENGINE_TYPE_DATE         HOTDBENGINE_TYPE_TIME
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_DATETIME     HOTDBENGINE_TYPE_YEAR
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_TINY,
         // HOTDBENGINE_TYPE_NEWDATE      HOTDBENGINE_TYPE_VARCHAR
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_BIT          HOTDBENGINE_TYPE_INVALID
         HOTDBENGINE_TYPE_LONGLONG, HOTDBENGINE_TYPE_INVALID,
         // HOTDBENGINE_TYPE_BOOL         HOTDBENGINE_TYPE_TINY
         HOTDBENGINE_TYPE_TINY, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_NEWDECIMAL   HOTDBENGINE_TYPE_ENUM
         HOTDBENGINE_TYPE_NEWDECIMAL, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_SET          HOTDBENGINE_TYPE_TINY_BLOB
         ...
         // HOTDBENGINE_TYPE_STRING       HOTDBENGINE_TYPE_GEOMETRY
         HOTDBENGINE_TYPE_STRING, HOTDBENGINE_TYPE_VARCHAR},
        /* HOTDBENGINE_TYPE_SHORT -> */
        {// HOTDBENGINE_TYPE_DECIMAL      HOTDBENGINE_TYPE_TINY
         HOTDBENGINE_TYPE_NEWDECIMAL, HOTDBENGINE_TYPE_SHORT,
         // HOTDBENGINE_TYPE_SHORT        HOTDBENGINE_TYPE_LONG
         HOTDBENGINE_TYPE_SHORT, HOTDBENGINE_TYPE_LONG,
         // HOTDBENGINE_TYPE_FLOAT        HOTDBENGINE_TYPE_DOUBLE
         HOTDBENGINE_TYPE_FLOAT, HOTDBENGINE_TYPE_DOUBLE,
         // HOTDBENGINE_TYPE_NULL         HOTDBENGINE_TYPE_TIMESTAMP
         HOTDBENGINE_TYPE_SHORT, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_LONGLONG     HOTDBENGINE_TYPE_INT24
         HOTDBENGINE_TYPE_LONGLONG, HOTDBENGINE_TYPE_INT24,
         // HOTDBENGINE_TYPE_DATE         HOTDBENGINE_TYPE_TIME
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_DATETIME     HOTDBENGINE_TYPE_YEAR
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_SHORT,
         // HOTDBENGINE_TYPE_NEWDATE      HOTDBENGINE_TYPE_VARCHAR
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_BIT          HOTDBENGINE_TYPE_INVALID
         HOTDBENGINE_TYPE_LONGLONG, HOTDBENGINE_TYPE_INVALID,
         ...
         // HOTDBENGINE_TYPE_STRING       HOTDBENGINE_TYPE_GEOMETRY
         HOTDBENGINE_TYPE_STRING, HOTDBENGINE_TYPE_VARCHAR},
        /* HOTDBENGINE_TYPE_LONG -> */
        {// HOTDBENGINE_TYPE_DECIMAL      HOTDBENGINE_TYPE_TINY
         HOTDBENGINE_TYPE_NEWDECIMAL, HOTDBENGINE_TYPE_LONG,
         // HOTDBENGINE_TYPE_SHORT        HOTDBENGINE_TYPE_LONG
         HOTDBENGINE_TYPE_LONG, HOTDBENGINE_TYPE_LONG,
         // HOTDBENGINE_TYPE_FLOAT        HOTDBENGINE_TYPE_DOUBLE
         HOTDBENGINE_TYPE_DOUBLE, HOTDBENGINE_TYPE_DOUBLE,
         // HOTDBENGINE_TYPE_NULL         HOTDBENGINE_TYPE_TIMESTAMP
         HOTDBENGINE_TYPE_LONG, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_LONGLONG     HOTDBENGINE_TYPE_INT24
         HOTDBENGINE_TYPE_LONGLONG, HOTDBENGINE_TYPE_LONG,
         // HOTDBENGINE_TYPE_DATE         HOTDBENGINE_TYPE_TIME
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_DATETIME     HOTDBENGINE_TYPE_YEAR
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_LONG,
         // HOTDBENGINE_TYPE_NEWDATE      HOTDBENGINE_TYPE_VARCHAR
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_BIT          HOTDBENGINE_TYPE_INVALID
         HOTDBENGINE_TYPE_LONGLONG, HOTDBENGINE_TYPE_INVALID,
         ...
         // HOTDBENGINE_TYPE_STRING       HOTDBENGINE_TYPE_GEOMETRY
         HOTDBENGINE_TYPE_STRING, HOTDBENGINE_TYPE_VARCHAR},
        /* HOTDBENGINE_TYPE_FLOAT -> */
        {// HOTDBENGINE_TYPE_DECIMAL      HOTDBENGINE_TYPE_TINY
         HOTDBENGINE_TYPE_DOUBLE, HOTDBENGINE_TYPE_FLOAT,
         // HOTDBENGINE_TYPE_SHORT        HOTDBENGINE_TYPE_LONG
         HOTDBENGINE_TYPE_FLOAT, HOTDBENGINE_TYPE_DOUBLE,
         // HOTDBENGINE_TYPE_FLOAT        HOTDBENGINE_TYPE_DOUBLE
         HOTDBENGINE_TYPE_FLOAT, HOTDBENGINE_TYPE_DOUBLE,
         // HOTDBENGINE_TYPE_NULL         HOTDBENGINE_TYPE_TIMESTAMP
         HOTDBENGINE_TYPE_FLOAT, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_LONGLONG     HOTDBENGINE_TYPE_INT24
         HOTDBENGINE_TYPE_FLOAT, HOTDBENGINE_TYPE_FLOAT,
         // HOTDBENGINE_TYPE_DATE         HOTDBENGINE_TYPE_TIME
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_DATETIME     HOTDBENGINE_TYPE_YEAR
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_FLOAT,
         // HOTDBENGINE_TYPE_NEWDATE      HOTDBENGINE_TYPE_VARCHAR
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_BIT          HOTDBENGINE_TYPE_INVALID
         HOTDBENGINE_TYPE_DOUBLE, HOTDBENGINE_TYPE_INVALID,
         // HOTDBENGINE_TYPE_BOOL         HOTDBENGINE_TYPE_JSON
         HOTDBENGINE_TYPE_FLOAT, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_NEWDECIMAL   HOTDBENGINE_TYPE_ENUM
         HOTDBENGINE_TYPE_DOUBLE, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_SET          HOTDBENGINE_TYPE_TINY_BLOB
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_TINY_BLOB,
         // HOTDBENGINE_TYPE_MEDIUM_BLOB  HOTDBENGINE_TYPE_LONG_BLOB
         HOTDBENGINE_TYPE_MEDIUM_BLOB, HOTDBENGINE_TYPE_LONG_BLOB,
        ...
        {// HOTDBENGINE_TYPE_DECIMAL      HOTDBENGINE_TYPE_TINY
         ...
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_DATETIME     HOTDBENGINE_TYPE_YEAR
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_DOUBLE,
         // HOTDBENGINE_TYPE_NEWDATE      HOTDBENGINE_TYPE_VARCHAR
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_BIT          HOTDBENGINE_TYPE_INVALID
         HOTDBENGINE_TYPE_DOUBLE, HOTDBENGINE_TYPE_INVALID,
        ...
        {// HOTDBENGINE_TYPE_DECIMAL      HOTDBENGINE_TYPE_TINY
         ...
         HOTDBENGINE_TYPE_NULL, HOTDBENGINE_TYPE_TIMESTAMP,
         // HOTDBENGINE_TYPE_LONGLONG     HOTDBENGINE_TYPE_INT24
         HOTDBENGINE_TYPE_LONGLONG, HOTDBENGINE_TYPE_LONGLONG,
         // HOTDBENGINE_TYPE_DATE         HOTDBENGINE_TYPE_TIME
         HOTDBENGINE_TYPE_NEWDATE, HOTDBENGINE_TYPE_TIME,
         // HOTDBENGINE_TYPE_DATETIME     HOTDBENGINE_TYPE_YEAR
         HOTDBENGINE_TYPE_DATETIME, HOTDBENGINE_TYPE_YEAR,
         // HOTDBENGINE_TYPE_NEWDATE      HOTDBENGINE_TYPE_VARCHAR
         HOTDBENGINE_TYPE_NEWDATE, HOTDBENGINE_TYPE_VARCHAR,
        ...
        {// HOTDBENGINE_TYPE_DECIMAL      HOTDBENGINE_TYPE_TINY
         ...
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_NULL         HOTDBENGINE_TYPE_TIMESTAMP
         HOTDBENGINE_TYPE_TIMESTAMP, HOTDBENGINE_TYPE_TIMESTAMP,
         // HOTDBENGINE_TYPE_LONGLONG     HOTDBENGINE_TYPE_INT24
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_DATE         HOTDBENGINE_TYPE_TIME
         HOTDBENGINE_TYPE_DATETIME, HOTDBENGINE_TYPE_DATETIME,
         // HOTDBENGINE_TYPE_DATETIME     HOTDBENGINE_TYPE_YEAR
         HOTDBENGINE_TYPE_DATETIME, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_NEWDATE      HOTDBENGINE_TYPE_VARCHAR
         HOTDBENGINE_TYPE_DATETIME, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_BIT          HOTDBENGINE_TYPE_INVALID
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_INVALID,
         // HOTDBENGINE_TYPE_BOOL         HOTDBENGINE_TYPE_JSON
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_NEWDECIMAL   HOTDBENGINE_TYPE_ENUM
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         ...
         // HOTDBENGINE_TYPE_STRING       HOTDBENGINE_TYPE_GEOMETRY
         HOTDBENGINE_TYPE_STRING, HOTDBENGINE_TYPE_VARCHAR},
        /* HOTDBENGINE_TYPE_LONGLONG -> */
        {// HOTDBENGINE_TYPE_DECIMAL      HOTDBENGINE_TYPE_TINY
         HOTDBENGINE_TYPE_NEWDECIMAL, HOTDBENGINE_TYPE_LONGLONG,
         // HOTDBENGINE_TYPE_SHORT        HOTDBENGINE_TYPE_LONG
         HOTDBENGINE_TYPE_LONGLONG, HOTDBENGINE_TYPE_LONGLONG,
         // HOTDBENGINE_TYPE_FLOAT        HOTDBENGINE_TYPE_DOUBLE
         HOTDBENGINE_TYPE_DOUBLE, HOTDBENGINE_TYPE_DOUBLE,
         // HOTDBENGINE_TYPE_NULL         HOTDBENGINE_TYPE_TIMESTAMP
         HOTDBENGINE_TYPE_LONGLONG, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_LONGLONG     HOTDBENGINE_TYPE_INT24
         HOTDBENGINE_TYPE_LONGLONG, HOTDBENGINE_TYPE_LONGLONG,
         // HOTDBENGINE_TYPE_DATE         HOTDBENGINE_TYPE_TIME
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_DATETIME     HOTDBENGINE_TYPE_YEAR
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_LONGLONG,
         // HOTDBENGINE_TYPE_NEWDATE      HOTDBENGINE_TYPE_VARCHAR
         HOTDBENGINE_TYPE_NEWDATE, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_BIT          HOTDBENGINE_TYPE_INVALID
         HOTDBENGINE_TYPE_LONGLONG, HOTDBENGINE_TYPE_INVALID,
         ...
         // HOTDBENGINE_TYPE_STRING       HOTDBENGINE_TYPE_GEOMETRY
         HOTDBENGINE_TYPE_STRING, HOTDBENGINE_TYPE_VARCHAR},
        /* HOTDBENGINE_TYPE_INT24 -> */
        {// HOTDBENGINE_TYPE_DECIMAL      HOTDBENGINE_TYPE_TINY
         HOTDBENGINE_TYPE_NEWDECIMAL, HOTDBENGINE_TYPE_INT24,
         // HOTDBENGINE_TYPE_SHORT        HOTDBENGINE_TYPE_LONG
         HOTDBENGINE_TYPE_INT24, HOTDBENGINE_TYPE_LONG,
         // HOTDBENGINE_TYPE_FLOAT        HOTDBENGINE_TYPE_DOUBLE
         HOTDBENGINE_TYPE_FLOAT, HOTDBENGINE_TYPE_DOUBLE,
         // HOTDBENGINE_TYPE_NULL         HOTDBENGINE_TYPE_TIMESTAMP
         HOTDBENGINE_TYPE_INT24, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_LONGLONG     HOTDBENGINE_TYPE_INT24
         HOTDBENGINE_TYPE_LONGLONG, HOTDBENGINE_TYPE_INT24,
         // HOTDBENGINE_TYPE_DATE         HOTDBENGINE_TYPE_TIME
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_DATETIME     HOTDBENGINE_TYPE_YEAR
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_INT24,
         // HOTDBENGINE_TYPE_NEWDATE      HOTDBENGINE_TYPE_VARCHAR
         HOTDBENGINE_TYPE_NEWDATE, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_BIT          HOTDBENGINE_TYPE_INVALID
         HOTDBENGINE_TYPE_LONGLONG, HOTDBENGINE_TYPE_INVALID,
        ...
        {// HOTDBENGINE_TYPE_DECIMAL      HOTDBENGINE_TYPE_TINY
         ...
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_NULL         HOTDBENGINE_TYPE_TIMESTAMP
         HOTDBENGINE_TYPE_NEWDATE, HOTDBENGINE_TYPE_DATETIME,
         // HOTDBENGINE_TYPE_LONGLONG     HOTDBENGINE_TYPE_INT24
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_DATE         HOTDBENGINE_TYPE_TIME
         HOTDBENGINE_TYPE_NEWDATE, HOTDBENGINE_TYPE_DATETIME,
        ...
        {// HOTDBENGINE_TYPE_DECIMAL      HOTDBENGINE_TYPE_TINY
         ...
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_NULL         HOTDBENGINE_TYPE_TIMESTAMP
         HOTDBENGINE_TYPE_TIME, HOTDBENGINE_TYPE_DATETIME,
         // HOTDBENGINE_TYPE_LONGLONG     HOTDBENGINE_TYPE_INT24
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_DATE         HOTDBENGINE_TYPE_TIME
         HOTDBENGINE_TYPE_DATETIME, HOTDBENGINE_TYPE_TIME,
         // HOTDBENGINE_TYPE_DATETIME     HOTDBENGINE_TYPE_YEAR
         HOTDBENGINE_TYPE_DATETIME, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_NEWDATE      HOTDBENGINE_TYPE_VARCHAR
         HOTDBENGINE_TYPE_NEWDATE, HOTDBENGINE_TYPE_VARCHAR,
        ...
        {// HOTDBENGINE_TYPE_DECIMAL      HOTDBENGINE_TYPE_TINY
         ...
         HOTDBENGINE_TYPE_FLOAT, HOTDBENGINE_TYPE_DOUBLE,
         // HOTDBENGINE_TYPE_NULL         HOTDBENGINE_TYPE_TIMESTAMP
         HOTDBENGINE_TYPE_YEAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_LONGLONG     HOTDBENGINE_TYPE_INT24
         HOTDBENGINE_TYPE_LONGLONG, HOTDBENGINE_TYPE_INT24,
         // HOTDBENGINE_TYPE_DATE         HOTDBENGINE_TYPE_TIME
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_DATETIME     HOTDBENGINE_TYPE_YEAR
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_YEAR,
         // HOTDBENGINE_TYPE_NEWDATE      HOTDBENGINE_TYPE_VARCHAR
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_BIT          HOTDBENGINE_TYPE_INVALID
         HOTDBENGINE_TYPE_LONGLONG, HOTDBENGINE_TYPE_INVALID,
        ...
        {// HOTDBENGINE_TYPE_DECIMAL      HOTDBENGINE_TYPE_TINY
         ...
         HOTDBENGINE_TYPE_DOUBLE, HOTDBENGINE_TYPE_DOUBLE,
         // HOTDBENGINE_TYPE_NULL         HOTDBENGINE_TYPE_TIMESTAMP
         HOTDBENGINE_TYPE_BIT, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_LONGLONG     HOTDBENGINE_TYPE_INT24
         HOTDBENGINE_TYPE_LONGLONG, HOTDBENGINE_TYPE_LONGLONG,
         // HOTDBENGINE_TYPE_DATE         HOTDBENGINE_TYPE_TIME
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         ...
         // HOTDBENGINE_TYPE_STRING       HOTDBENGINE_TYPE_GEOMETRY
         HOTDBENGINE_TYPE_STRING, HOTDBENGINE_TYPE_VARCHAR},
        /* HOTDBENGINE_TYPE_INVALID -> */
        {// HOTDBENGINE_TYPE_DECIMAL      HOTDBENGINE_TYPE_TINY
         HOTDBENGINE_TYPE_INVALID, HOTDBENGINE_TYPE_INVALID,
         // HOTDBENGINE_TYPE_SHORT        HOTDBENGINE_TYPE_LONG
         HOTDBENGINE_TYPE_INVALID, HOTDBENGINE_TYPE_INVALID,
         // HOTDBENGINE_TYPE_FLOAT        HOTDBENGINE_TYPE_DOUBLE
         HOTDBENGINE_TYPE_INVALID, HOTDBENGINE_TYPE_INVALID,
        ...
        {// HOTDBENGINE_TYPE_DECIMAL      HOTDBENGINE_TYPE_TINY
         ...
         HOTDBENGINE_TYPE_FLOAT, HOTDBENGINE_TYPE_DOUBLE,
         // HOTDBENGINE_TYPE_NULL         HOTDBENGINE_TYPE_TIMESTAMP
         HOTDBENGINE_TYPE_BOOL, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_LONGLONG     HOTDBENGINE_TYPE_INT24
         HOTDBENGINE_TYPE_LONGLONG, HOTDBENGINE_TYPE_INT24,
         // HOTDBENGINE_TYPE_DATE         HOTDBENGINE_TYPE_TIME
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
        ...
        {// HOTDBENGINE_TYPE_DECIMAL      HOTDBENGINE_TYPE_TINY
         ...
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_NULL         HOTDBENGINE_TYPE_TIMESTAMP
         HOTDBENGINE_TYPE_JSON, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_LONGLONG     HOTDBENGINE_TYPE_INT24
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_DATE         HOTDBENGINE_TYPE_TIME
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         ...
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_INVALID,
         // HOTDBENGINE_TYPE_BOOL         HOTDBENGINE_TYPE_JSON
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_JSON,
         // HOTDBENGINE_TYPE_NEWDECIMAL   HOTDBENGINE_TYPE_ENUM
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_SET          HOTDBENGINE_TYPE_TINY_BLOB
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_LONG_BLOB,
         // HOTDBENGINE_TYPE_MEDIUM_BLOB  HOTDBENGINE_TYPE_LONG_BLOB
         HOTDBENGINE_TYPE_LONG_BLOB, HOTDBENGINE_TYPE_LONG_BLOB,
         // HOTDBENGINE_TYPE_BLOB         HOTDBENGINE_TYPE_VAR_STRING
         HOTDBENGINE_TYPE_LONG_BLOB, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_STRING       HOTDBENGINE_TYPE_GEOMETRY
         HOTDBENGINE_TYPE_STRING, HOTDBENGINE_TYPE_VARCHAR},
        /* HOTDBENGINE_TYPE_NEWDECIMAL -> */
        {// HOTDBENGINE_TYPE_DECIMAL      HOTDBENGINE_TYPE_TINY
         HOTDBENGINE_TYPE_NEWDECIMAL, HOTDBENGINE_TYPE_NEWDECIMAL,
         // HOTDBENGINE_TYPE_SHORT        HOTDBENGINE_TYPE_LONG
         HOTDBENGINE_TYPE_NEWDECIMAL, HOTDBENGINE_TYPE_NEWDECIMAL,
         ...
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_DATETIME     HOTDBENGINE_TYPE_YEAR
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_NEWDECIMAL,
         // HOTDBENGINE_TYPE_NEWDATE      HOTDBENGINE_TYPE_VARCHAR
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_BIT          HOTDBENGINE_TYPE_INVALID
         HOTDBENGINE_TYPE_NEWDECIMAL, HOTDBENGINE_TYPE_INVALID,
        ...
        {// HOTDBENGINE_TYPE_DECIMAL      HOTDBENGINE_TYPE_TINY
         ...
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_NULL         HOTDBENGINE_TYPE_TIMESTAMP
         HOTDBENGINE_TYPE_ENUM, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_LONGLONG     HOTDBENGINE_TYPE_INT24
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_DATE         HOTDBENGINE_TYPE_TIME
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
        ...
        {// HOTDBENGINE_TYPE_DECIMAL      HOTDBENGINE_TYPE_TINY
         ...
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_NULL         HOTDBENGINE_TYPE_TIMESTAMP
         HOTDBENGINE_TYPE_SET, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_LONGLONG     HOTDBENGINE_TYPE_INT24
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_DATE         HOTDBENGINE_TYPE_TIME
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         ...
         // HOTDBENGINE_TYPE_STRING       HOTDBENGINE_TYPE_GEOMETRY
         HOTDBENGINE_TYPE_STRING, HOTDBENGINE_TYPE_VARCHAR},
        /* HOTDBENGINE_TYPE_TINY_BLOB -> */
        {// HOTDBENGINE_TYPE_DECIMAL      HOTDBENGINE_TYPE_TINY
         HOTDBENGINE_TYPE_TINY_BLOB, HOTDBENGINE_TYPE_TINY_BLOB,
         // HOTDBENGINE_TYPE_SHORT        HOTDBENGINE_TYPE_LONG
         HOTDBENGINE_TYPE_TINY_BLOB, HOTDBENGINE_TYPE_TINY_BLOB,
         // HOTDBENGINE_TYPE_FLOAT        HOTDBENGINE_TYPE_DOUBLE
         HOTDBENGINE_TYPE_TINY_BLOB, HOTDBENGINE_TYPE_TINY_BLOB,
         ...
         HOTDBENGINE_TYPE_TINY_BLOB, HOTDBENGINE_TYPE_TINY_BLOB,
         // HOTDBENGINE_TYPE_BIT          HOTDBENGINE_TYPE_INVALID
         HOTDBENGINE_TYPE_TINY_BLOB, HOTDBENGINE_TYPE_INVALID,
         // HOTDBENGINE_TYPE_BOOL         HOTDBENGINE_TYPE_JSON
         HOTDBENGINE_TYPE_TINY_BLOB, HOTDBENGINE_TYPE_LONG_BLOB,
         // HOTDBENGINE_TYPE_NEWDECIMAL   HOTDBENGINE_TYPE_ENUM
         HOTDBENGINE_TYPE_TINY_BLOB, HOTDBENGINE_TYPE_TINY_BLOB,
         // HOTDBENGINE_TYPE_SET          HOTDBENGINE_TYPE_TINY_BLOB
         HOTDBENGINE_TYPE_TINY_BLOB, HOTDBENGINE_TYPE_TINY_BLOB,
         ...
         HOTDBENGINE_TYPE_MEDIUM_BLOB, HOTDBENGINE_TYPE_LONG_BLOB,
         // HOTDBENGINE_TYPE_BLOB         HOTDBENGINE_TYPE_VAR_STRING
         HOTDBENGINE_TYPE_BLOB, HOTDBENGINE_TYPE_TINY_BLOB,
         // HOTDBENGINE_TYPE_STRING       HOTDBENGINE_TYPE_GEOMETRY
         HOTDBENGINE_TYPE_TINY_BLOB, HOTDBENGINE_TYPE_TINY_BLOB},
        /* HOTDBENGINE_TYPE_MEDIUM_BLOB -> */
        {// HOTDBENGINE_TYPE_DECIMAL      HOTDBENGINE_TYPE_TINY
         HOTDBENGINE_TYPE_MEDIUM_BLOB, HOTDBENGINE_TYPE_MEDIUM_BLOB,
         // HOTDBENGINE_TYPE_SHORT        HOTDBENGINE_TYPE_LONG
         HOTDBENGINE_TYPE_MEDIUM_BLOB, HOTDBENGINE_TYPE_MEDIUM_BLOB,
         // HOTDBENGINE_TYPE_FLOAT        HOTDBENGINE_TYPE_DOUBLE
         HOTDBENGINE_TYPE_MEDIUM_BLOB, HOTDBENGINE_TYPE_MEDIUM_BLOB,
         ...
         HOTDBENGINE_TYPE_MEDIUM_BLOB, HOTDBENGINE_TYPE_MEDIUM_BLOB,
         // HOTDBENGINE_TYPE_BIT          HOTDBENGINE_TYPE_INVALID
         HOTDBENGINE_TYPE_MEDIUM_BLOB, HOTDBENGINE_TYPE_INVALID,
         // HOTDBENGINE_TYPE_BOOL         HOTDBENGINE_TYPE_JSON
         HOTDBENGINE_TYPE_MEDIUM_BLOB, HOTDBENGINE_TYPE_LONG_BLOB,
         // HOTDBENGINE_TYPE_NEWDECIMAL   HOTDBENGINE_TYPE_ENUM
         HOTDBENGINE_TYPE_MEDIUM_BLOB, HOTDBENGINE_TYPE_MEDIUM_BLOB,
        ...
        {// HOTDBENGINE_TYPE_DECIMAL      HOTDBENGINE_TYPE_TINY
         ...
         HOTDBENGINE_TYPE_LONG_BLOB, HOTDBENGINE_TYPE_LONG_BLOB,
         // HOTDBENGINE_TYPE_BIT          HOTDBENGINE_TYPE_INVALID
         HOTDBENGINE_TYPE_LONG_BLOB, HOTDBENGINE_TYPE_INVALID,
         // HOTDBENGINE_TYPE_BOOL         HOTDBENGINE_TYPE_JSON
         HOTDBENGINE_TYPE_LONG_BLOB, HOTDBENGINE_TYPE_LONG_BLOB,
         // HOTDBENGINE_TYPE_NEWDECIMAL   HOTDBENGINE_TYPE_ENUM
         HOTDBENGINE_TYPE_LONG_BLOB, HOTDBENGINE_TYPE_LONG_BLOB,
         ...
         // HOTDBENGINE_TYPE_STRING       HOTDBENGINE_TYPE_GEOMETRY
         HOTDBENGINE_TYPE_LONG_BLOB, HOTDBENGINE_TYPE_LONG_BLOB},
        /* HOTDBENGINE_TYPE_BLOB -> */
        {// HOTDBENGINE_TYPE_DECIMAL      HOTDBENGINE_TYPE_TINY
         HOTDBENGINE_TYPE_BLOB, HOTDBENGINE_TYPE_BLOB,
         // HOTDBENGINE_TYPE_SHORT        HOTDBENGINE_TYPE_LONG
         HOTDBENGINE_TYPE_BLOB, HOTDBENGINE_TYPE_BLOB,
         // HOTDBENGINE_TYPE_FLOAT        HOTDBENGINE_TYPE_DOUBLE
         HOTDBENGINE_TYPE_BLOB, HOTDBENGINE_TYPE_BLOB,
         ...
         HOTDBENGINE_TYPE_BLOB, HOTDBENGINE_TYPE_BLOB,
         // HOTDBENGINE_TYPE_BIT          HOTDBENGINE_TYPE_INVALID
         HOTDBENGINE_TYPE_BLOB, HOTDBENGINE_TYPE_INVALID,
         // HOTDBENGINE_TYPE_BOOL         HOTDBENGINE_TYPE_JSON
         HOTDBENGINE_TYPE_BLOB, HOTDBENGINE_TYPE_LONG_BLOB,
         // HOTDBENGINE_TYPE_NEWDECIMAL   HOTDBENGINE_TYPE_ENUM
         HOTDBENGINE_TYPE_BLOB, HOTDBENGINE_TYPE_BLOB,
         // HOTDBENGINE_TYPE_SET          HOTDBENGINE_TYPE_TINY_BLOB
         HOTDBENGINE_TYPE_BLOB, HOTDBENGINE_TYPE_BLOB,
        ...
        {// HOTDBENGINE_TYPE_DECIMAL      HOTDBENGINE_TYPE_TINY
         ...
         // HOTDBENGINE_TYPE_STRING       HOTDBENGINE_TYPE_GEOMETRY
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR},
        /* HOTDBENGINE_TYPE_STRING -> */
        {// HOTDBENGINE_TYPE_DECIMAL      HOTDBENGINE_TYPE_TINY
         HOTDBENGINE_TYPE_STRING, HOTDBENGINE_TYPE_STRING,
         // HOTDBENGINE_TYPE_SHORT        HOTDBENGINE_TYPE_LONG
         HOTDBENGINE_TYPE_STRING, HOTDBENGINE_TYPE_STRING,
         // HOTDBENGINE_TYPE_FLOAT        HOTDBENGINE_TYPE_DOUBLE
         HOTDBENGINE_TYPE_STRING, HOTDBENGINE_TYPE_STRING,
         ...
         HOTDBENGINE_TYPE_STRING, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_BIT          HOTDBENGINE_TYPE_INVALID
         HOTDBENGINE_TYPE_STRING, HOTDBENGINE_TYPE_INVALID,
         // HOTDBENGINE_TYPE_BOOL         HOTDBENGINE_TYPE_JSON
         HOTDBENGINE_TYPE_STRING, HOTDBENGINE_TYPE_STRING,
         // HOTDBENGINE_TYPE_NEWDECIMAL   HOTDBENGINE_TYPE_ENUM
         HOTDBENGINE_TYPE_STRING, HOTDBENGINE_TYPE_STRING,
         // HOTDBENGINE_TYPE_SET          HOTDBENGINE_TYPE_TINY_BLOB
         HOTDBENGINE_TYPE_STRING, HOTDBENGINE_TYPE_TINY_BLOB,
         // HOTDBENGINE_TYPE_MEDIUM_BLOB  HOTDBENGINE_TYPE_LONG_BLOB
         HOTDBENGINE_TYPE_MEDIUM_BLOB, HOTDBENGINE_TYPE_LONG_BLOB,
         // HOTDBENGINE_TYPE_BLOB         HOTDBENGINE_TYPE_VAR_STRING
         HOTDBENGINE_TYPE_BLOB, HOTDBENGINE_TYPE_VARCHAR,
        ...
        {// HOTDBENGINE_TYPE_DECIMAL      HOTDBENGINE_TYPE_TINY
         ...
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_NULL         HOTDBENGINE_TYPE_TIMESTAMP
         HOTDBENGINE_TYPE_GEOMETRY, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_LONGLONG     HOTDBENGINE_TYPE_INT24
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
         // HOTDBENGINE_TYPE_DATE         HOTDBENGINE_TYPE_TIME
         HOTDBENGINE_TYPE_VARCHAR, HOTDBENGINE_TYPE_VARCHAR,
...
enum_field_types Field::field_type_merge(enum_field_types a,
                                         enum_field_types b) {
  assert(a != HOTDBENGINE_TYPE_INVALID && b != HOTDBENGINE_TYPE_INVALID);
  return (enum_field_types)field_types_merge_rules[field_type2index(a)][field_type2index(b)];
}
...
bool Field::type_can_have_key_part(enum enum_field_types type) {
  switch (type) {
    case HOTDBENGINE_TYPE_VARCHAR:
    case HOTDBENGINE_TYPE_TINY_BLOB:
    case HOTDBENGINE_TYPE_MEDIUM_BLOB:
    case HOTDBENGINE_TYPE_LONG_BLOB:
    case HOTDBENGINE_TYPE_BLOB:
    case HOTDBENGINE_TYPE_VAR_STRING:
    case HOTDBENGINE_TYPE_STRING:
    case HOTDBENGINE_TYPE_GEOMETRY:
      return true;
    default:
      return false;
  }
...
*/
type_conversion_status Field_num::store_time(HOTDBENGINE_TIME *ltime, uint8) {
...
bool Field_num::get_date(HOTDBENGINE_TIME *ltime, my_time_flags_t fuzzydate) const {
  assert(result_type() == INT_RESULT);
  return my_longlong_to_datetime_with_warn(val_int(), ltime, fuzzydate);
}

bool Field_num::get_time(HOTDBENGINE_TIME *ltime) const {
  assert(result_type() == INT_RESULT);
...
bool Field::get_date(HOTDBENGINE_TIME *ltime, my_time_flags_t fuzzydate) const {
...
bool Field::get_time(HOTDBENGINE_TIME *ltime) const {
  char buff[MAX_DATE_STRING_REP_LENGTH];
  String tmp(buff, sizeof(buff), &my_charset_bin), *res;
...
type_conversion_status Field::store_time(HOTDBENGINE_TIME *ltime, uint8 dec_arg) {
  ASSERT_COLUMN_MARKED_FOR_WRITE;
  char buff[MAX_DATE_STRING_REP_LENGTH];
...
type_conversion_status Field_new_decimal::store_time(HOTDBENGINE_TIME *ltime, uint8) {
  my_decimal decimal_value;
...
bool Field_new_decimal::get_date(HOTDBENGINE_TIME *ltime,
                                 my_time_flags_t fuzzydate) const {
  my_decimal buf, *decimal_value = val_decimal(&buf);
  if (!decimal_value) {
    set_zero_time(ltime, (enum_mysql_timestamp_type)HOTDBENGINE_TIMESTAMP_DATETIME);
    return true;
  }
  return my_decimal_to_datetime_with_warn(decimal_value, ltime, fuzzydate);
}

bool Field_new_decimal::get_time(HOTDBENGINE_TIME *ltime) const {
  my_decimal buf, *decimal_value = val_decimal(&buf);
  if (!decimal_value) {
    set_zero_time(ltime, HOTDBENGINE_TIMESTAMP_TIME);
    return true;
  }
...
type_conversion_status Field_real::store_time(HOTDBENGINE_TIME *ltime, uint8) {
...
bool Field_real::get_date(HOTDBENGINE_TIME *ltime, my_time_flags_t fuzzydate) const {
  return my_double_to_datetime_with_warn(val_real(), ltime, fuzzydate);
}

bool Field_real::get_time(HOTDBENGINE_TIME *ltime) const {
...
bool Field_temporal::set_warnings(const ErrConvString &str, int warnings) {
  ...
  if (warnings & HOTDBENGINE_TIME_WARN_TRUNCATED) {
  ...
  if (warnings & (HOTDBENGINE_TIME_WARN_OUT_OF_RANGE | HOTDBENGINE_TIME_WARN_ZERO_DATE |
                  HOTDBENGINE_TIME_WARN_ZERO_IN_DATE)) {
  ...
  if (warnings & HOTDBENGINE_TIME_WARN_INVALID_TIMESTAMP) {
    if (set_datetime_warning(Sql_condition::SL_WARNING,
  ...
  if ((warnings & HOTDBENGINE_TIME_NOTE_TRUNCATED) &&
      !(warnings & HOTDBENGINE_TIME_WARN_TRUNCATED)) {
...
type_conversion_status Field_temporal::store(longlong nr, bool unsigned_val) {
  ...
  if (error == TYPE_OK || error == TYPE_NOTE_TRUNCATED)
    ...
    if (warnings & (HOTDBENGINE_TIME_WARN_ZERO_DATE | HOTDBENGINE_TIME_WARN_ZERO_IN_DATE) &&
...
type_conversion_status Field_temporal::store_lldiv_t(const lldiv_t *lld,
  ...
  if (error == TYPE_OK || error == TYPE_NOTE_TRUNCATED)
    ...
    if (((*warnings & HOTDBENGINE_TIME_WARN_ZERO_DATE) != 0 ||
         (*warnings & HOTDBENGINE_TIME_WARN_ZERO_IN_DATE) != 0) &&
        !current_thd->is_strict_mode())
      error = TYPE_NOTE_TIME_TRUNCATED;
  }
...
type_conversion_status Field_temporal::store(const char *str, size_t len,
  ...
  type_conversion_status error = TYPE_OK;
  HOTDBENGINE_TIME ltime;
  HOTDBENGINE_TIME_STATUS status;
  if (convert_str_to_TIME(str, len, cs, &ltime, &status)) {
    ...
    */
    reset();
    if (status.warnings &
            (HOTDBENGINE_TIME_WARN_ZERO_DATE | HOTDBENGINE_TIME_WARN_ZERO_IN_DATE) &&
        !current_thd->is_strict_mode())
      error = TYPE_NOTE_TIME_TRUNCATED;
    else
    ...
    if (ltime.time_type == HOTDBENGINE_TIMESTAMP_DATETIME_TZ) {
      /*
      ...
      */
      HOTDBENGINE_TIME tmp_ltime = ltime;
...
bool Field_temporal_with_date::get_internal_check_zero(
    HOTDBENGINE_TIME *ltime, my_time_flags_t fuzzydate) const {
  if (get_date_internal(ltime)) /* '0000-00-00' */
  {
    assert(type() == HOTDBENGINE_TYPE_TIMESTAMP);
    if (fuzzydate & TIME_NO_ZERO_DATE) return true;
    set_zero_time(ltime, HOTDBENGINE_TIMESTAMP_DATETIME);
  }
  return false;
}
...
type_conversion_status Field_temporal_with_date::convert_number_to_TIME(
    longlong nr, bool unsigned_val, int nanoseconds, HOTDBENGINE_TIME *ltime,
    int *warnings) {
  if (nr < 0 || nanoseconds < 0) {
    reset();
    *warnings |= HOTDBENGINE_TIME_WARN_OUT_OF_RANGE;
    return TYPE_WARN_OUT_OF_RANGE;
  }
  ...
  if (ltime->time_type == HOTDBENGINE_TIMESTAMP_DATE && nanoseconds) {
    *warnings |= HOTDBENGINE_TIME_WARN_TRUNCATED;
...
type_conversion_status Field_temporal_with_date::store_time(HOTDBENGINE_TIME *ltime,
                                                            uint8) {
  ASSERT_COLUMN_MARKED_FOR_WRITE;
  type_conversion_status error;
  int warnings = 0;
  ...
  {
    case HOTDBENGINE_TIMESTAMP_DATETIME:
    case HOTDBENGINE_TIMESTAMP_DATETIME_TZ:
    case HOTDBENGINE_TIMESTAMP_DATE:
      if (check_date(*ltime, non_zero_date(*ltime), date_flags(), &warnings)) {
        assert(warnings &
               (HOTDBENGINE_TIME_WARN_OUT_OF_RANGE | HOTDBENGINE_TIME_WARN_ZERO_DATE |
                HOTDBENGINE_TIME_WARN_ZERO_IN_DATE));
      ...
      break;
    case HOTDBENGINE_TIMESTAMP_TIME: {
      /* Convert TIME to DATETIME */
      THD *thd = current_thd;
      HOTDBENGINE_TIME ltime2;
      time_to_datetime(thd, ltime, &ltime2);
      error = store_internal_adjust_frac(&ltime2, &warnings);
      break;
    }
    case HOTDBENGINE_TIMESTAMP_NONE:
    case HOTDBENGINE_TIMESTAMP_ERROR:
    default:
      warnings |= HOTDBENGINE_TIME_WARN_TRUNCATED;
      reset();
...
bool Field_temporal_with_date::send_to_protocol(Protocol *protocol) const {
  ...
  HOTDBENGINE_TIME ltime;
  if (get_date_internal(&ltime)) {
    // Only HOTDBENGINE_TYPE_TIMESTAMP can return an error in get_date_internal()
    assert(type() == HOTDBENGINE_TYPE_TIMESTAMP);
    set_zero_time(&ltime, HOTDBENGINE_TIMESTAMP_DATETIME);
  }
...
type_conversion_status Field_temporal_with_date::store_internal_adjust_frac(
    HOTDBENGINE_TIME *ltime, int *warnings) {
...
type_conversion_status Field_temporal_with_date::validate_stored_val(THD *) {
  ...
  memset(&ltime, 0, sizeof(HOTDBENGINE_TIME));
...
bool Field_temporal_with_date_and_time::convert_TIME_to_timestamp(
    const HOTDBENGINE_TIME *ltime, const Time_zone &tz, my_timeval *tm,
    int *warnings) {
  /*
...
type_conversion_status Field_timestamp::store_internal(const HOTDBENGINE_TIME *ltime,
                                                       int *warnings) {
  THD *thd = current_thd;
  my_timeval tm;
...
bool Field_timestamp::get_date_internal(HOTDBENGINE_TIME *ltime) const {
  THD *thd = current_thd;
  return get_date_internal_at(thd->time_zone(), ltime);
}

bool Field_timestamp::get_date_internal_at_utc(HOTDBENGINE_TIME *ltime) const {
  return get_date_internal_at(my_tz_UTC, ltime);
}

bool Field_timestamp::get_date_internal_at(const Time_zone *tz,
                                           HOTDBENGINE_TIME *ltime) const {
  ASSERT_COLUMN_MARKED_FOR_READ;
...
bool Field_timestamp::get_date(HOTDBENGINE_TIME *ltime,
                               my_time_flags_t fuzzydate) const {
...
type_conversion_status Field_timestampf::store_internal(const HOTDBENGINE_TIME *ltime,
                                                        int *warnings) {
  THD *thd = current_thd;
  my_timeval tm;
  convert_TIME_to_timestamp(ltime, *thd->time_zone(), &tm, warnings);
...
bool Field_timestampf::get_date(HOTDBENGINE_TIME *ltime,
                                my_time_flags_t fuzzydate) const {
  /* Don't do check_fuzzy_date() as month and year are never 0 for timestamp */
  return get_internal_check_zero(ltime, fuzzydate);
}
...
bool Field_timestampf::get_date_internal(HOTDBENGINE_TIME *ltime) const {
  THD *thd = current_thd;
  return get_date_internal_at(thd->time_zone(), ltime);
}

bool Field_timestampf::get_date_internal_at_utc(HOTDBENGINE_TIME *ltime) const {
  return get_date_internal_at(my_tz_UTC, ltime);
}
...
type_conversion_status Field_time_common::store_time(HOTDBENGINE_TIME *ltime, uint8) {
  ...
  if (ltime->second >= 60 || ltime->minute >= 60) {
    if (set_warnings(ErrConvString(ltime, decimals()),
                     HOTDBENGINE_TIME_WARN_OUT_OF_RANGE))
      return TYPE_ERR_BAD_VALUE;
    reset();
    return TYPE_WARN_OUT_OF_RANGE;
  }
...
bool Field_time_common::get_date(HOTDBENGINE_TIME *ltime, my_time_flags_t) const {
  ASSERT_COLUMN_MARKED_FOR_READ;
  HOTDBENGINE_TIME tm;
  if (get_time(&tm)) {
    assert(0);
...
longlong Field_time_common::val_date_temporal() const {
  ASSERT_COLUMN_MARKED_FOR_READ;
  HOTDBENGINE_TIME time, datetime;
  if (get_time(&time)) {
...
type_conversion_status Field_time::store_internal(const HOTDBENGINE_TIME *ltime,
                                                  int *) {
...
bool Field_time::get_time(HOTDBENGINE_TIME *ltime) const {
  long tmp = (long)sint3korr(ptr);
  if ((ltime->neg = tmp < 0)) tmp = -tmp;
  ltime->year = ltime->month = ltime->day = 0;
  TIME_set_hhmmss(ltime, tmp);
  ltime->second_part = 0;
  ltime->time_type = HOTDBENGINE_TIMESTAMP_TIME;
  return false;
}
...
type_conversion_status Field_timef::store_internal(const HOTDBENGINE_TIME *ltime,
                                                   int *warnings) {
  /*
 ...
 */
  HOTDBENGINE_TIME temp_time;
  const HOTDBENGINE_TIME *time;
  if (ltime->time_type == HOTDBENGINE_TIMESTAMP_DATETIME_TZ) {
    temp_time = *ltime;
    time = &temp_time;
  ...
  if (rc == TYPE_OK && non_zero_date(*ltime)) {
    ...
    */
    *warnings |= HOTDBENGINE_TIME_NOTE_TRUNCATED;
    rc = TYPE_NOTE_TIME_TRUNCATED;
  }
  return rc;
}

bool Field_timef::get_time(HOTDBENGINE_TIME *ltime) const {
...
type_conversion_status Field_year::store_time(HOTDBENGINE_TIME *ltime, uint8) {
  if (ltime->time_type != HOTDBENGINE_TIMESTAMP_DATETIME &&
      ltime->time_type != HOTDBENGINE_TIMESTAMP_DATE) {
...
type_conversion_status Field_newdate::store_internal(const HOTDBENGINE_TIME *ltime,
                                                     int *warnings) {
  /*
    If time zone displacement information is present in "ltime"
    - adjust the value to UTC based on the time zone
...
bool Field_newdate::get_date_internal(HOTDBENGINE_TIME *ltime) const {
...
bool Field_newdate::get_date(HOTDBENGINE_TIME *ltime,
                             my_time_flags_t fuzzydate) const {
  return get_internal_check_zero(ltime, fuzzydate) ||
...
bool Field_datetime::get_date_internal(HOTDBENGINE_TIME *ltime) const {
  longlong tmp = datetime_get_internal(table, ptr);
  ltime->time_type = HOTDBENGINE_TIMESTAMP_DATETIME;
  ltime->neg = false;
  ltime->second_part = 0;
...
type_conversion_status Field_datetime::store_internal(const HOTDBENGINE_TIME *ltime,
                                                      int *) {
...
/*
  ...
  to avoid conversion from number to HOTDBENGINE_TIME.
...
bool Field_datetime::get_date(HOTDBENGINE_TIME *ltime,
                              my_time_flags_t fuzzydate) const {
  return get_internal_check_zero(ltime, fuzzydate) ||
         check_fuzzy_date(*ltime, fuzzydate);
}
...
bool Field_datetimef::get_date(HOTDBENGINE_TIME *ltime,
                               my_time_flags_t fuzzydate) const {
  return get_internal_check_zero(ltime, fuzzydate) ||
         check_fuzzy_date(*ltime, fuzzydate);
}
...
bool Field_datetimef::get_date_internal(HOTDBENGINE_TIME *ltime) const {
  TIME_from_longlong_datetime_packed(ltime, val_date_temporal());
  return false;
}

type_conversion_status Field_datetimef::store_internal(const HOTDBENGINE_TIME *ltime,
                                                       int *) {
  /*
    If time zone displacement information is present in "ltime"
    - adjust the value to UTC based on the time zone
...
static bool check_field_for_37426(const void *param_arg) {
  ...
  assert(param->field->real_type() == HOTDBENGINE_TYPE_STRING);
  DBUG_PRINT("debug",
...
void Field_string::sql_type(String &res) const {
  ...
  length = cs->cset->snprintf(
      ...
      ((type() == HOTDBENGINE_TYPE_VAR_STRING && !thd->variables.new_mode)
...
Field_json *Field_json::clone(MEM_ROOT *mem_root) const {
  assert(type() == HOTDBENGINE_TYPE_JSON);
...
type_conversion_status Field_json::store_time(HOTDBENGINE_TIME *, uint8) {
  return unsupported_conversion();
}
...
bool Field_json::get_date(HOTDBENGINE_TIME *ltime, my_time_flags_t) const {
  ASSERT_COLUMN_MARKED_FOR_READ;

  Json_wrapper wr;
  bool result = val_json(&wr) || wr.coerce_date(ltime, field_name);
  if (result)
    set_zero_time(ltime, HOTDBENGINE_TIMESTAMP_DATETIME); /* purecov: inspected */
  return result;
}

bool Field_json::get_time(HOTDBENGINE_TIME *ltime) const {
  ASSERT_COLUMN_MARKED_FOR_READ;

  Json_wrapper wr;
  bool result = val_json(&wr) || wr.coerce_time(ltime, field_name);
  if (result)
    set_zero_time(ltime, HOTDBENGINE_TIMESTAMP_TIME); /* purecov: inspected */
  return result;
}
...
uint32 calc_key_length(enum_field_types sql_type, uint32 length,
  ...
  switch (sql_type) {
    ...
    case HOTDBENGINE_TYPE_BLOB:
    case HOTDBENGINE_TYPE_GEOMETRY:
    case HOTDBENGINE_TYPE_JSON:
      return 0;
    case HOTDBENGINE_TYPE_VARCHAR:
      return length;
    case HOTDBENGINE_TYPE_ENUM:
      return get_enum_pack_length(elements);
    case HOTDBENGINE_TYPE_SET:
      return get_set_pack_length(elements);
    case HOTDBENGINE_TYPE_BIT:
      return length / 8 + (length & 7 ? 1 : 0);
      break;
    case HOTDBENGINE_TYPE_NEWDECIMAL:
...
enum_field_types get_blob_type_from_length(size_t length) {
  ...
  if (length < 256)
    type = HOTDBENGINE_TYPE_TINY_BLOB;
  else if (length < 65536)
    type = HOTDBENGINE_TYPE_BLOB;
  else if (length < 256L * 256L * 256L)
    type = HOTDBENGINE_TYPE_MEDIUM_BLOB;
  else
    type = HOTDBENGINE_TYPE_LONG_BLOB;
  return type;
}
...
size_t calc_pack_length(enum_field_types type, size_t length) {
  switch (type) {
    case HOTDBENGINE_TYPE_VAR_STRING:
    case HOTDBENGINE_TYPE_STRING:
    case HOTDBENGINE_TYPE_DECIMAL:
      return (length);
    case HOTDBENGINE_TYPE_VARCHAR:
      return (length + (length < 256 ? 1 : 2));
    case HOTDBENGINE_TYPE_BOOL:
    case HOTDBENGINE_TYPE_YEAR:
    case HOTDBENGINE_TYPE_TINY:
      return 1;
    case HOTDBENGINE_TYPE_SHORT:
      return 2;
    case HOTDBENGINE_TYPE_INT24:
    case HOTDBENGINE_TYPE_NEWDATE:
      return 3;
    case HOTDBENGINE_TYPE_TIME:
      return 3;
    case HOTDBENGINE_TYPE_TIME2:
      return length > MAX_TIME_WIDTH
                 ? my_time_binary_length(length - MAX_TIME_WIDTH - 1)
                 : 3;
    case HOTDBENGINE_TYPE_TIMESTAMP:
      return 4;
    case HOTDBENGINE_TYPE_TIMESTAMP2:
      return length > MAX_DATETIME_WIDTH
                 ? my_timestamp_binary_length(length - MAX_DATETIME_WIDTH - 1)
                 : 4;
    case HOTDBENGINE_TYPE_DATE:
    case HOTDBENGINE_TYPE_LONG:
      return 4;
    case HOTDBENGINE_TYPE_FLOAT:
      return sizeof(float);
    case HOTDBENGINE_TYPE_DOUBLE:
      return sizeof(double);
    case HOTDBENGINE_TYPE_DATETIME:
      return 8;
    case HOTDBENGINE_TYPE_DATETIME2:
      return length > MAX_DATETIME_WIDTH
                 ? my_datetime_binary_length(length - MAX_DATETIME_WIDTH - 1)
                 : 5;
    case HOTDBENGINE_TYPE_LONGLONG:
      return 8; /* Don't crash if no longlong */
    case HOTDBENGINE_TYPE_NULL:
      return 0;
    case HOTDBENGINE_TYPE_TINY_BLOB:
    ...
    case HOTDBENGINE_TYPE_BIT:
      return length / 8;
    case HOTDBENGINE_TYPE_INVALID:
    case HOTDBENGINE_TYPE_TYPED_ARRAY:
      break;
  }
  assert(false);
  return 0;
...
Field *make_field(MEM_ROOT *mem_root, TABLE_SHARE *share, uchar *ptr,
  ...
  if (field_type == HOTDBENGINE_TYPE_BIT && !treat_bit_as_char) {
    bit_ptr = null_pos;
    bit_offset = null_bit;
  ...
  if (is_array) {
    ...
    */
    uint pack_length = calc_pack_length(HOTDBENGINE_TYPE_JSON, field_length) -
  ...
  /*
    FRMs from 3.23/4.0 can have strings with field_type == HOTDBENGINE_TYPE_DECIMAL.
...
Field_typed_array::Field_typed_array(
  ...
  */
  ...
  assert(elt_type != HOTDBENGINE_TYPE_STRING && elt_type != HOTDBENGINE_TYPE_VAR_STRING);
}
    ...
    switch (data->type()) {
      ...
      case enum_json_type::J_ARRAY: {
        ...
        for (size_t i = 0; i < data->length(); i++) {
          ...
          if (type() == HOTDBENGINE_TYPE_VARCHAR)
        ...
        */
        if (array->size() > 1)
          array->remove_duplicates(type() == HOTDBENGINE_TYPE_VARCHAR ? m_elt_charset
                                                                : nullptr);
...
void Field_typed_array::init(TABLE *table_arg) {
  ...
  if (type() == HOTDBENGINE_TYPE_NEWDECIMAL)
...
void Field_typed_array::make_send_field(Send_field *field) const {
  ...
  field->type = HOTDBENGINE_TYPE_JSON;
}
